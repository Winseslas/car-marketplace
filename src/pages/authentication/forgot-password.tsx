        ...
        <>
            <div className='w-full  max-w-md mx-auto p-6'>
                ...
                <p className="mt-3 flex justify-center items-center text-center divide-x divide-gray-300 dark:divide-gray-700">
                    <Link className="pr-3.5 inline-flex items-center gap-x-2 text-sm text-gray-600 decoration-2 hover:text-blue-600 dark:text-gray-500 dark:hover:text-gray-200" to="https://github.com/" title='Github' target="_blank">
